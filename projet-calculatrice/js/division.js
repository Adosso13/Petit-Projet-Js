...
const changementdivision = document.getElementById("changement-de-ligne-division")
const changementdivisionrestart = document.getElementById("changement-de-ligne-division-restart")
changementdivisionrestart.style.display= "none"



changementdivision.addEventListener("click", function () {
    const btn1er = document.querySelectorAll(".bouton1er")
    btn1er.forEach(b=>b.style.display = "none")
    btn2d.forEach(b2=>b2.style.display = "block")
    changementdivision.style.display="none"
    changementdivisionrestart.style.display= "block"
})

changementdivisionrestart.addEventListener("click", function () {
    const btn2d = document.querySelectorAll(".bouton2d")
    btn1er.forEach(b=>b.style.display = "block")
    btn2d.forEach(b2=>b2.style.display = "none")
    changementdivision.style.display="block"
    changementdivisionrestart.style.display= "none"
})
