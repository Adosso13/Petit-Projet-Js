...
const changementsoustraction = document.getElementById("changement-de-ligne-soustraction")
const changementsoustractionrestart = document.getElementById("changement-de-ligne-soustraction-restart")
changementsoustractionrestart.style.display= "none"



changementsoustraction.addEventListener("click", function () {
    const btn1er = document.querySelectorAll(".bouton1er")
    btn1er.forEach(b=>b.style.display = "none")
    btn2d.forEach(b2=>b2.style.display = "block")
    changementsoustraction.style.display="none"
    changementsoustractionrestart.style.display= "block"
})

changementsoustractionrestart.addEventListener("click", function () {
    const btn2d = document.querySelectorAll(".bouton2d")
    btn1er.forEach(b=>b.style.display = "block")
    btn2d.forEach(b2=>b2.style.display = "none")
    changementsoustraction.style.display="block"
    changementsoustractionrestart.style.display= "none"
})
