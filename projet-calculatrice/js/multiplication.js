...
const changementmultiplication = document.getElementById("changement-de-ligne-multiplication")
const changementmultiplicationrestart = document.getElementById("changement-de-ligne-multiplication-restart")
changementmultiplicationrestart.style.display= "none"



changementmultiplication.addEventListener("click", function () {
    const btn1er = document.querySelectorAll(".bouton1er")
    btn1er.forEach(b=>b.style.display = "none")
    btn2d.forEach(b2=>b2.style.display = "block")
    changementmultiplication.style.display="none"
    changementmultiplicationrestart.style.display= "block"
})

changementmultiplicationrestart.addEventListener("click", function () {
    const btn2d = document.querySelectorAll(".bouton2d")
    btn1er.forEach(b=>b.style.display = "block")
    btn2d.forEach(b2=>b2.style.display = "none")
    changementmultiplication.style.display="block"
    changementmultiplicationrestart.style.display= "none"
})
